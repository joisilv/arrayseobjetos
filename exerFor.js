...
/*function comprimentoMedioPalavras (string1, string2){
let media = parseInt(string1.length + string2.length) / 2;
return  media;
}

console.log(comprimentoMedioPalavras('string1','string2'));*/
...
if(nome.length >=3 && senha.length >=8){
    return true;
    console.log('Válida');
}else { console.log ('Invalida')};

}

credencialEhValida('Joice',3941285);*/
